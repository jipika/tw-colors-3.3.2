...
This project is a fork of tw-colors, adding the display of color decorators in vscode. The default theme for setting different light and dark themes is displayed as light, and a single default theme displays the set theme color.
